...
build()
{
	...
	--host=aarch64-apple-darwin --disable-assembly --enable-static --disable-shared --enable-cxx ${ARGS}
...
lipo \
        "${CURRENT}/gmplib-armv7/lib/libgmpxx.a" \
        "${CURRENT}/gmplib-arm64/lib/libgmpxx.a" \
        "${CURRENT}/gmplib-i386/lib/libgmpxx.a" \
        "${CURRENT}/gmplib-x64_86/lib/libgmpxx.a" \
        -create -output lib/libgmpxx.a

echo "lib done"
echo "${CURRENT}/lib/libgmp.a"
echo "${CURRENT}/lib/libgmpxx.a"
